...
router.get('/assi-edit/:oid', async (req, res) => {
    ...
    if (assi) {
        res.render('dashboard/edit/assi', { title: 'Assistant editor', appChassis: res.appChassis, assi });
    } else {
...
router.get('/acti-edit/:oid', async (req, res) => {
    ...
    if (acti) {
        res.render('dashboard/edit/acti', { title: 'Activity editor', appChassis: res.appChassis, acti });
    } else {
